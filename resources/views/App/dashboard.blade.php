@extends('index')
@section('dashboard-nav','here show')
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                        ...
                        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                            ...
                            <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                <!--begin::Title-->
                                <h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold fs-3 m-0">My Projects</h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                    ...
                    <div id="kt_app_content_container" class="app-container container-fluid">
                            ...
                            <div class="col-lg-6 col-xxl-4">
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body p-9">
                                        <!--begin::Heading-->
                                        <div class="fs-2hx fw-bold">500</div>
                                        ...
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <div class="d-flex flex-column justify-content-center flex-row-fluid pe-11 mb-5">
                                                ...
                                                <div class="d-flex fs-6 fw-semibold align-items-center mb-3">
                                                    ...
                                                    <div class="ms-auto fw-bold text-gray-700">300</div>
                                                </div>
                                                <!--end::Label-->
                                                <!--begin::Label-->
                                                <div class="d-flex fs-6 fw-semibold align-items-center mb-3">
                                                    ...
                                                    <div class="ms-auto fw-bold text-gray-700">100</div>
                                                </div>
                                                <!--end::Label-->
                                                <!--begin::Label-->
                        ...
                        <div class="row g-6 g-xl-9">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <!--begin::Card-->
                                <a href="../../demo38/dist/apps/projects/project.html" class="card border-hover-primary">
                                    <!--begin::Card header-->
