...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            <!--begin::Form-->
            <form id="kt_account_profile_details_form" class="form" action="{{route('updateDetails',$user->id)}}" method="POST">
                @csrf
                <!--begin::Card body-->
                <div class="card-body border-top p-9">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 fv-row">
                                    <input type="text" name="name" class="form-control form-control-lg  mb-3 mb-lg-0 d-non" placeholder="Full Name" value="{{$user->name}}" />
                                    @error('name')
                                        <span class="text-danger-emphasis px-2">{{$message}}</span>
                                    @enderror
                                </div>

                                <!--end::Col-->
                                <!--begin::Col-->
                                {{-- <div class="col-lg-6 fv-row d-none">
                                    <input type="text" name="lname" class="form-control form-control-lg " placeholder="Last name" value="Smith" />
                                </div> --}}
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="tel" name="phone" class="form-control form-control-lg " placeholder="Phone number" value="{{$user->phone}}" />
                             @error('phone')
                                <span class="text-danger-emphasis px-2">{{$message}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <select name="gender" aria-label="Select a Country" data-control="select2" data-placeholder="Select gender" data-hide-search="true" class="form-select d form-select-lg fw-semibold">
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <textarea name="address" id="" class="form-control form-control-lg" cols="30" rows="10" placeholder="Enter Address">{{$user->address}}</textarea>
                            @error('address')
                                <span class="text-danger-emphasis px-2">{{$message}}</span>
                            @enderror
                        </div>
