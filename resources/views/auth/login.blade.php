				...
				<div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
					...
					<div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
						...
						<div class="py-20">
                            ...
                            {{-- @if (session('status'))
                                <div class="mb-4 font-medium text-sm text-green-600 dark:text-green-400 text-danger">
                                    {{ session('status') }}
                                </div>
                            @endif --}}
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="#" action="{{route('login')}}" method="POST">
								...
								<div class="card-body">
									...
									<div class="fv-row mb-8">
										<!--begin::Email-->
										<input type="text" placeholder="Username" name="username" autocomplete="off" data-kt-translate="sign-in-input-email" class="form-control " />
										<!--end::Email-->
									</div>
									<!--end::Input group=-->
									...
									<div class="d-flex flex-stack">
										{{-- <!--begin::Submit-->id="kt_sign_in_submit" --}}
